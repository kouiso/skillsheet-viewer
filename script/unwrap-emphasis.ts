 ...
 *
 *   ドライラン: pnpm exec tsx script/unwrap-emphasis.ts
 *   書き込み:   pnpm exec tsx script/unwrap-emphasis.ts --write
 */
import { mkdirSync, writeFileSync } from 'node:fs';

import { type BlockInput, isProjectBlockData, type ProjectItem } from '../src/db/block';
