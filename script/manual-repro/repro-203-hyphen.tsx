 ...
 * true になってしまっていた（patch/@react-pdf__textkit@6.3.0.patch で修正）。
 *
 * 使い方:
 *   DATABASE_URL=... pnpm exec tsx script/manual-repro/repro-203-hyphen.tsx <sheetId>
 */
...
import PDF_FONT_FAMILY from '../../src/component/pdf/constant';
import { splitForHyphenation } from '../../src/component/pdf/font';
