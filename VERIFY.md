...
packages/db test:    Start at  15:13:37
packages/db test:    Duration  757ms (transform 101ms, setup 0ms, collect 90ms, tests 6ms, environment 0ms, prepare 161ms)
...
apps/web test:  ✓ src/context/theme-context.test.tsx (9 tests) 94ms
...
apps/web test: /* assert on the output */
apps/web test: This ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.dev/link/wrap-tests-with-act
apps/web test:  ✓ src/hooks/use-active-heading.test.ts (16 tests) 250ms
apps/web test:  ✓ src/component/header.test.tsx (8 tests) 595ms
apps/web test:    ✓ Header > PDF機能 > クリックで onDownloadPdf が呼ばれること  359ms
...
apps/web test: <PAGE /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.
apps/web test: <DOCUMENT /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.
apps/web test:  ✓ src/component/pdf-export.test.tsx (11 tests) 633ms
apps/web test:  ✓ src/component/table-of-contents.test.tsx (5 tests) 1088ms
apps/web test:  ✓ src/component/code-block.test.tsx (8 tests) 1013ms
apps/web test:    ✓ CodeBlock > レンダリング > 言語ラベルが表示されること  399ms
apps/web test:    ✓ CodeBlock > コピー機能 > ボタン押下でクリップボードにコードが書き込まれること  394ms
apps/web test:  ✓ app/builder/builder-client.test.tsx (5 tests) 810ms
apps/web test:    ✓ BuilderClient > 「ブロック追加」で空ブロックが増える  398ms
apps/web test:  ✓ src/component/skill-sheet-viewer.test.tsx (1 test) 123ms
...
apps/web test:    Start at  15:13:39
apps/web test:    Duration  19.12s (transform 1.49s, setup 4.16s, collect 8.62s, tests 4.77s, environment 12.33s, prepare 2.07s)
apps/web test: Done
```
