...
## Issue取得
```text
$ gh issue view 13 --repo kouiso/skillsheet-viewer
/bin/bash: line 8: gh: command not found
exit=127
$ gh issue view 1 --repo kouiso/skillsheet-viewer
...
```text
$ pnpm run lint
mise ERROR error parsing config file: /workspace/skillsheet-viewer/mise.toml
mise ERROR Config files in /workspace/skillsheet-viewer/mise.toml are not trusted.
...
Checked 90 files in 155ms. No fixes applied.
Found 4 warnings.
exit=0
```
...
packages/db test:    Start at  12:58:51
packages/db test:    Duration  756ms (transform 105ms, setup 0ms, collect 87ms, tests 6ms, environment 0ms, prepare 158ms)
...
apps/web test: /* assert on the output */
apps/web test: This ensures that you're testing the behavior the user would see in the browser. Learn more at https://react.dev/link/wrap-tests-with-act
apps/web test:  ✓ src/hooks/use-active-heading.test.ts (16 tests) 247ms
apps/web test:  ✓ src/component/header.test.tsx (8 tests) 606ms
apps/web test:    ✓ Header > PDF機能 > クリックで onDownloadPdf が呼ばれること  338ms
...
apps/web test: <PAGE /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.
apps/web test: <DOCUMENT /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.
apps/web test:  ✓ src/component/pdf-export.test.tsx (11 tests) 531ms
apps/web test:  ✓ src/component/table-of-contents.test.tsx (5 tests) 1056ms
apps/web test:    ✓ TableOfContents（デスクトップ表示） > 「目次」見出しが表示されること  337ms
apps/web test:  ✓ src/component/code-block.test.tsx (8 tests) 1082ms
apps/web test:    ✓ CodeBlock > レンダリング > 言語ラベルが表示されること  445ms
apps/web test:    ✓ CodeBlock > コピー機能 > ボタン押下でクリップボードにコードが書き込まれること  337ms
apps/web test:  ✓ app/builder/builder-client.test.tsx (5 tests) 817ms
apps/web test:    ✓ BuilderClient > 「ブロック追加」で空ブロックが増える  422ms
apps/web test:  ✓ src/component/skill-sheet-viewer.test.tsx (1 test) 173ms
...
apps/web test: <PAGE /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.
apps/web test: <DOCUMENT /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.
apps/web test:  ✓ src/component/pdf/skill-sheet-document.test.tsx (5 tests) 174ms
apps/web test:  Test Files  9 passed (9)
apps/web test:       Tests  68 passed (68)
apps/web test:    Start at  12:58:52
apps/web test:    Duration  19.24s (transform 1.39s, setup 4.11s, collect 8.82s, tests 4.78s, environment 12.41s, prepare 1.97s)
apps/web test: Done
exit=0
```
...
✓ Generating static pages using 2 workers (9/9) in 798ms
