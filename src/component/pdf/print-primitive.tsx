 ...
 *      `render` に頼らない（print-leaf-list.tsx / print-page.tsx）。
 */
 ...
 * レガシー markdown 経路（render-node.tsx）は toRenderableText を自前で呼んでいるが、
...
const styles = StyleSheet.create({
  ...
  // 分類同士の間隔。分類ごとに葉になるので、間隔は葉の枠（print-leaf-list.tsx）が持つ。
