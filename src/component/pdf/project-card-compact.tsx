 ...
 *
 * 1 段目と 2 段目の各ブロックはそれぞれ measure-then-place の葉になる（print-leaf-list.tsx）。
...
import { Chip, PrintText, SectionLabel } from './print-primitive';
...
const styles = StyleSheet.create({
  ...
  // 詳細版の techChips（print-primitive.tsx）と同じ折り返し行。分類ラベル列は持たない。
