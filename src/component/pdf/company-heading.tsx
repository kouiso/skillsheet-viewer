 ...
 * 1 軸しかないので、モノクロコピーでも情報は落ちない（print-token.ts の設計方針）。
 *
 ...
 * （print-leaf-list.tsx）、「見出しだけがページ末尾に残らない」は `keepWithNext` で表現する。
...
import { Paragraph, PrintText } from './print-primitive';
