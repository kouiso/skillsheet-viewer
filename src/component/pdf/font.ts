...
const NotoSansJPRegular = '/font/noto-sans-jp-regular.ttf';
const NotoSansJPBold = '/font/noto-sans-jp-bold.ttf';
...
// （patch/@react-pdf__textkit@6.3.0.patch の hyphenated 判定も
