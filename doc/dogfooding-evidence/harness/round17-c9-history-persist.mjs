...
await p.screenshot({ path: `${OUT}/C-9-before-restore.png` });
...
await p.screenshot({ path: `${OUT}/C-9-history-drawer.png` });
...
writeFileSync(`${OUT}/C-9-persist.json`, JSON.stringify(r, null, 2));
