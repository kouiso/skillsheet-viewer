...
// Mutation: src/component/pdf/print-document.tsx の
...
// Mutation: src/component/pdf/print-view-model.ts の buildTechGroups で
...
// Mutation: component/viewer-topbar.tsx の PDF ボタンから `disabled={pdfLoading}` を外す。
// ---------------------------------------------------------------------------
